...
type Jwt struct {
	...
	AccessTokenExpire  int    `json:"-" yaml:"access_token_expire" mapstructure:"access_token_expire"`
	RefreshTokenExpire int    `json:"-" yaml:"refresh_token_expire" mapstructure:"refresh_token_expire"`
